# CRM MAX - Система записи клиентов для мессенджера MAX

## 📋 Описание

CRM MAX — это комплексная система для управления записями клиентов в мессенджере MAX. Система позволяет мастерам (стилистам, косметологам, барберам и др.) создать свою онлайн-запись через уникальную ссылку, а клиентам — записываться к ним без звонков и сообщений.
